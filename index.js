            ...
            if(data)
            {
                ...
                if(isvalid)
                {
                        ...
                        let info = await transporter.sendMail({
                            ...
                            to: req.body.email, 
                            subject: "Hi!", 
                            html: "<h3>Hello "+data.firstname+"</h3><p>logged in sucessfully, have wonderful shopping expoerience</p>", 
                        })
                        console.log(info);
                        res.status(200).json({message:"Login Success",email,firstname,lastName});
